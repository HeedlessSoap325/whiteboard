<script lang="ts">
	const {width, height, color}: {width: string, height: string, color: string} = $props();
</script>

<!-- Source: https://www.svgrepo.com/svg/31904/arrow-angle-pointing-up -->
